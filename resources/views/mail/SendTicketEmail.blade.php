...
.invoice-body{
    ...
    <body>
                    ...
                    <div class = "invoice-head">
                        ...
                        <div class = "invoice-head-middle">
                            ...
                            <div class = "invoice-head-middle-left text-start">
                                ...
                                <p style="margin-bottom: 4px;"><span class = "text-bold" style="padding-right: 11px;">Reply by:</span>{{ $data['reply_by'] }}</p>
                            </div>
        ...
        <div class="card-body" style="margin-top:20px; padding: 20px;">
            {!! strip_tags($data['message'], '<p><a><strong><em><br><img><figure><figcaption>') !!}
            </div>
            <div id="replyLink" style="text-align: center; margin-top: 20px;">
            <a href="https://app.thescouts.com.au/#/support" style="color: #0c8a6c; text-decoration: underline;">Click here for reply</a>
            </div>
                        </div>
                    </div>
