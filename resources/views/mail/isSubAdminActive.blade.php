                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding:0 15px;">
                                                <h1 style="color:rgb(0, 163, 126); font-weight:400; margin:0;font-size:32px;">{{@$email}}</h1>   
                                                <h4>Welcome {{@$name}} !</h4>
                                                <p style="font-size:15px; color:#171f23de; margin:8px 0 0; line-height:24px;"><strong>{{@$msg}}</strong></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height:40px;">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td style="padding:0 15px;">
                                                <p style="font-size:15px; color:#171f23de; margin:8px 0 0; line-height:24px;">
                                                ...
                                                <!-- {!!$qr_img!!} -->
                                                <!-- <img src="data:image/svg+xml;base64,{{ base64_encode($qr_img) }}" alt="QR Code"> -->
