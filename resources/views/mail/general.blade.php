...
<!-- style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;" -->
<body>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align:-webkit-center;">
                                <img style="width: 7rem; height: 7rem;" src="https://app.247staffingsolutions.com.au/assets/images/logo/scouts.png" alt="AMG Security">
                            </td>
                        </tr>
                        <!-- <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding:0 15px;">
                                                <h1 style="color:rgb(0, 163, 126); font-weight:400; margin:0;font-size:32px;">AMG Security</h1>
                                                <p style="font-size:15px; color:#171f23de; margin:8px 0 0; line-height:24px;">{{@$token}}</p>
                                               <a href="https://play.google.com/store/apps/details?id=au.com.securitygroup.app&pli=1" target="_blank" style="background:#3075BA;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 12px;display:inline-block;border-radius:3px;">Show in App</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height:40px;">&nbsp;</td>
