...
export class FormBuildService {
  ...
  public saveJsonForm(data): Observable<any> {
    let link = this.global.baseUrl + 'submit-dynamic-form';
  ...
  // public StoreEmpDetail(data): Observable<any> {
  //   let link = this.global.baseUrl + 'update-emp-details';
  //   return this.http.post<any>(link, data, this.httpOptions)
  //     .pipe(retry(1));
  // }

  // public GetEmpDetail(data): Observable<any> {
  //   let link = this.global.baseUrl + 'get-emp-details';
  //   return this.http.post<any>(link, data, this.httpOptions)
  //     .pipe(retry(1));
  // }
