...
@Component({
  selector: 'app-ento-fortnight-design',
  templateUrl: './ento-fortnight-design.component.html',
  styleUrls: ['./ento-fortnight-design.component.scss']
})
export class EntoFortnightDesignComponent implements OnInit {
 ...
 /*Next week*/
  ...
  getDays(e) {
    ...
    console.log("next ",this.globals.entoSelectedWeek);
