...
import { GuardLicenseService } from './../../../services/guard-license.service';
...
@Component({
  selector: 'app-guard-license',
  templateUrl: './guard-license.component.html',
  styleUrls: ['./guard-license.component.scss']
})
export class GuardLicenseComponent implements OnInit {
  startPage = 1;
  searchTerm: string;
  documents = [];
  guradList = [];
