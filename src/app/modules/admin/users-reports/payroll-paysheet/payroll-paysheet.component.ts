...
@Component({
  selector: 'app-payroll-paysheet',
  templateUrl: './payroll-paysheet.component.html',
  styleUrls: ['../users-reports.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class PayrollPaysheetComponent implements OnInit {
  ...
  getReports(type, sheet) {
    ...
    this.resportService.PayrollPaysheet(data).subscribe(({ success, path, data }) => {
      ...
      if (success && type == 'excel') {
        ...
        this.trackAdmin.storeActivity('Payroll Paysheet Report', `Download a xlxs file`, localStorage.getItem('routerId')).subscribe(() => {
        })
      }
