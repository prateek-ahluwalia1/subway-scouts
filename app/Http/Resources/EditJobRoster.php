...
class EditJobRoster extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return[
            ...
            'adhoc_shift' => $this->adhoc_shift,
            'reimbursement' => $this->reimbursement ,
            'reimbursement_text' => $this->reimbursement_text ,
            'reimbursement_value' => $this->reimbursement_value ,
            ...
            'admin_confirm' => $this->admin_confirm,
            ...
            'jobRosterTasks' =>  jobRosterTaskResource::collection($this->jobRosterTask),
        ];
    }
}
